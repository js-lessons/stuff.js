...
function ProductComponent(product) {
  var html = [
    '<a href="#" class="span4 add-to-cart" data-product="<%= code %>">',
      '<img class="span3" src="<%= img %>" alt="<%= title %>">',
    '</a>'
  ].join("\n");
...
function CartProductComponent(product) {
  var html = [
    '<div class="row product">',
      '<img class="span3" src="<%= product.img %>" alt="<%= product.title %>">',
      '<div class="span5">',
        '<h3><%= product.title %></h3>',
        '<p>',
          '<%= product.description %>',
      ...
      '<div class="price span2">$<%= product.price %></div>',
      '<input data-product="<%= product.id %>" type="number" min="1" class="span1" value="<%= product.quantity %>" />',
